...
//"/eos/cms/store/group/phys_exotica/dijet/Dijet13TeV/dimitris/ScoutingQCDtoBeTransfered/IncludingMet/QCD_Patatrack_30GeV/Patatrack_QCD_30GeVthreshold.root"
"/tmp/dkarasav/qcd_.root"
//"/afs/cern.ch/work/d/dkarasav/public/ScoutingTriggers/test2_Abijith/CMSSW_11_1_0_pre8/src/pfpatatrackvalidation/ProducerTest/QCD_8_45GeV_ptdependent.root",
//"/afs/cern.ch/work/d/dkarasav/public/ScoutingTriggers/test2_Abijith/CMSSW_11_1_0_pre8/src/pfpatatrackvalidation/ProducerTest/QCD_15_45GeV_ptdependent.root"
...
//static char output_directory[200] = {"QCD_sample_plots/Full_statistics/matced/High_pT_regime/FT_vs_PatLoose_vs_PatTight//"}; 
static char output_directory[200] = {"Testing_pTdependent_Criteria/FullStatistics/RemoveTrackCaloAverage_0p5/Low_pT_regime/"}; 
//static char output_directory[200] = {"Testing_pTdependent_Criteria/15_45GeVThreshold/Low_pT_regime/"}; 
static char image_name[200] = {"LowpT"}; 
...
static char legend_array[][500] = { "FullTracking" ,  "PatatrackTight", "PatatrackLoose", "CaloOnlyAbove0p5"  };
...
static double pThighCut = 350;
static bool useWeights = true;
static bool useGausFits = true; //only used for jet pT resolution calculations


static int EventsToProcess = 3000000; //negative value will process all events in each tree
...
static double YaxisLowEndMultiplier = 0.00001; // define lower bound of Y axis for plot: Lower Bound = YaxisLowEndMultiplier* histo_maximum
...
static int PadColumnsPtBins = 3; 
static int PadRowsPtBins = 3;
