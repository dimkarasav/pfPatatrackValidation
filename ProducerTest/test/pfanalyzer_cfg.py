...
#                                 fileName=cms.string("PixelTracking_Scouting_dijet.root")
                                 fileName=cms.string("Patatrack_Candidates_ttbar_14TeV_ParamCheck1.root")
#                                 fileName=cms.string("FullTracking_Scouting_trees_newProducer.root")
                                 )
...
#        'file:outputScoutingPF_pixelTracking_gpu_DevMC_ZJetsPU_CleanedZeta01_2vtx_Dec19.root'
 ...
 #   'file:/afs/cern.ch/work/d/dkarasav/public/ScoutingTriggers/CMSSW_11_0_0_pre13/src/outputScoutingPF_LegacyPixelTracks_CleanModules.root'
    '/store/user/dkarasav/ScoutingFiles/edmOutputs/110X_mcRun3_2021_realistic_v6-v1/RelVal_ttbar/outputScoutingPF_PatatrackPixelTracks_ttbar_14TeV_ParamCheck1.root'
 #   'file:/afs/cern.ch/work/d/dkarasav/public/ScoutingTriggers/CMSSW_11_0_0_pre13/src/outputScoutingPF_FullTracking_Zmumu.root'
